...
public class TVLV2Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tvlv2);
    ...
    public void anhxa(){
        tvQuestion = findViewById(R.id.tv_questionNumtv2);
        tvContent = findViewById(R.id.tv_cauhoi_tvLV2);
        tvAnswer1 = findViewById(R.id.btn_dapan1tv2);
        tvAnswer2 = findViewById(R.id.btn_dapan2tv2);
        tvAnswer3 = findViewById(R.id.btn_dapan3tv2);
        tvAnswer4 = findViewById(R.id.btn_dapan4tv2);
    ...
    public void checkAnswer(Question question,Answer answer){
        AlertDialog.Builder builder = new AlertDialog.Builder(TVLV2Activity.this);
        LayoutInflater inflater = TVLV2Activity.this.getLayoutInflater();
    ...
    private void nextQuestion() {
        if (currentQuestion == mlist.size() - 1){
            AlertDialog.Builder builder3 = new AlertDialog.Builder(TVLV2Activity.this);
            LayoutInflater inflater3 = TVLV2Activity.this.getLayoutInflater();
            ...
            new Handler().postDelayed(new Runnable() {
                ...
                public void run() {
                    alertDialog.dismiss();
                    Intent intent = new Intent(TVLV2Activity.this, TVLV3Activity.class);
