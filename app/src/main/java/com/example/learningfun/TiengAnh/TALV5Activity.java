...
public class TALV5Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_talv5);
    ...
    public void anhxa(){
        tvQuestion = findViewById(R.id.tv_questionNumta5);
        tvContent = findViewById(R.id.tv_cauhoi_taLV5);
        tvAnswer1 = findViewById(R.id.btn_dapan1ta5);
        tvAnswer2 = findViewById(R.id.btn_dapan2ta5);
        tvAnswer3 = findViewById(R.id.btn_dapan3ta5);
        tvAnswer4 = findViewById(R.id.btn_dapan4ta5);
    ...
    public void checkAnswer(Question question,Answer answer){
        AlertDialog.Builder builder = new AlertDialog.Builder(TALV5Activity.this);
        LayoutInflater inflater = TALV5Activity.this.getLayoutInflater();
    ...
    private void nextQuestion() {
        if (currentQuestion == mlist.size() - 1){
            AlertDialog.Builder builder3 = new AlertDialog.Builder(TALV5Activity.this);
            LayoutInflater inflater3 = TALV5Activity.this.getLayoutInflater();
            ...
            new Handler().postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    btnhome.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            Intent intent = new Intent(TALV5Activity.this, MainActivity.class);
                    ...
                    btncon.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            Intent intent = new Intent(TALV5Activity.this, TALV1Activity.class);
                            startActivity(intent);
                        }
                    });
                }
