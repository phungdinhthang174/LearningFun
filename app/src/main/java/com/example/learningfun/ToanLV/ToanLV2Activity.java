...
public class ToanLV2Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.toan_lv2);
        anhxa();
    ...
    public void anhxa(){
        tvQuestion = findViewById(R.id.tv_questionNum2);
        tvContent = findViewById(R.id.tv_cauhoi_toanLV2);
    ...
    private List<Question> getListQuestion(){
        ...
        answerList.add(new Answer("10",false));
        answerList.add(new Answer("20",false));
        answerList.add(new Answer("30",false));
        answerList.add(new Answer("40",true));

        List<Answer> answerList1 = new ArrayList<>();
        answerList1.add(new Answer("5",false));
        answerList1.add(new Answer("10",true));
        answerList1.add(new Answer("15",false));
        answerList1.add(new Answer("20",false));

        List<Answer> answerList2 = new ArrayList<>();
        answerList2.add(new Answer("56",false));
        answerList2.add(new Answer("59",false));
        answerList2.add(new Answer("58",true));
        answerList2.add(new Answer("60",false));

        List<Answer> answerList3 = new ArrayList<>();
        answerList3.add(new Answer("64",false));
        answerList3.add(new Answer("74",true));
        answerList3.add(new Answer("84",false));
        answerList3.add(new Answer("70",false));
        List<Answer> answerList4 = new ArrayList<>();
        answerList4.add(new Answer("30",false));
        answerList4.add(new Answer("60",false));
        answerList4.add(new Answer("50",false));
        answerList4.add(new Answer("40",true));




        questionList.add(new Question(1,"Em hãy tính 30+10?",answerList));
        questionList.add(new Question(2,"Kết quả của phép tính 25-15 là :",answerList1));
        questionList.add(new Question(3,"Kết quả của phép tính 72-14 là :",answerList2));
        questionList.add(new Question(4,"Kết quả của phép tính 50+24 là :",answerList3));
        questionList.add(new Question(5,"Kết quả của phép tính 17+23 là :",answerList4));
        return questionList;
    ...
    public void checkAnswer(Question question,Answer answer){
        AlertDialog.Builder builder = new AlertDialog.Builder(ToanLV2Activity.this);
        LayoutInflater inflater = ToanLV2Activity.this.getLayoutInflater();
    ...
    private void nextQuestion() {
        if (currentQuestion == mlist.size() - 1){
            AlertDialog.Builder builder3 = new AlertDialog.Builder(ToanLV2Activity.this);
            LayoutInflater inflater3 = ToanLV2Activity.this.getLayoutInflater();
            ...
            new Handler().postDelayed(new Runnable() {
                ...
                public void run() {
                    alertDialog.dismiss();
                    Intent intent = new Intent(ToanLV2Activity.this,ToanLV3Activity.class);
